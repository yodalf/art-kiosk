...
### 12-Period Day Scheduling with Mirroring

Time periods 7-12 automatically mirror periods 1-6:

```
Setting Period 1 (6-8 AM) also sets Period 7 (6-8 PM)
```

This provides a 12-hour repeating pattern with only 6 configuration slots.
